...
- DessMonitor app do not display PV2 for Daxtromn AGH 10.2kw version, just PV1 and total consumption and some settings; Formula I have found in a several tests is: pv2 = (ac_output - grid_power) / efficiency - battery_net - pv1.
	Where:
